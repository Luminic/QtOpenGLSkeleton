...
PointLight::PointLight(glm::vec3 color, float ambient, float diffuse, float specular, glm::vec3 position, glm::vec3 scale) :
  Object({glm::vec3(1.0f),glm::vec3(1.0f),glm::vec3(1.0f),0}, position, scale),
  color(color),
  ambient(ambient),
  diffuse(diffuse),
  specular(specular)
