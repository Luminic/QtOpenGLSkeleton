...
void OpenGLWindow::paintGL() {
  ...
  draw_objects(depth_shader, false, 0);
  ...
  draw_objects(object_shader, true, 2);
...
void OpenGLWindow::draw_objects(Shader *shader, bool use_material, int material_index_offset) {
